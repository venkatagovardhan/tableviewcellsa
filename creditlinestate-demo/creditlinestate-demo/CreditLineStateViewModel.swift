//
//  CreditLineStateViewModel.swift
...
extension NSMutableAttributedString {
    ...
    func appendFontText(_ string: String, font: UIFont, color: UIColor) {
        let newString = NSAttributedString(string: string,
                                           attributes: [.font: font, .foregroundColor: color])
        append(newString)
    }
    
    func appendLinkableText(_ string: String, font: UIFont, color: UIColor, link: String) {
        let newString = NSAttributedString(string: string,
...
enum CreditLineState {
    ...
    var containerBGColor: UIColor {
        switch self {
        case .counterOffer:
            return UIColor.rgb(r: 25, g: 55, b: 255)
        case .approved:
...
class CreditLineStateViewModel {
    
    var currentState: CreditLineState?
    
    // MARK: - Getters
    
    func getContainerBGColor() -> UIColor? {
        guard let state = currentState else { return nil }
        return state.containerBGColor
    }
